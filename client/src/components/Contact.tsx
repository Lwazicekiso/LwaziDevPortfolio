...
import { FaEnvelope, FaPhone, FaLink, FaLinkedin, FaGithub, FaFileDownload } from "react-icons/fa";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:lwazicekiso112@gmail.com" className="text-blue-400 hover:text-blue-300">lwazicekiso112@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+27661221850" className="text-blue-400 hover:text-blue-300">+27 66 122 1850</a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="https://shorturl.at/0YNvT" className="text-blue-400 hover:text-blue-300">https://shorturl.at/0YNvT</a>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <form className="space-y-6">
              ...
              <Button 
                type="submit" 
                className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-lg transition-all shadow-lg hover:shadow-blue-500/20 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
              >
                Send Message
              </Button>
            </form>
